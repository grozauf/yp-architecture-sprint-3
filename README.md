...
- Целевое значение устройства (DeviceTargeValue)
...
- Сущность "Протокол взаимодействия с устройством":
  - id - уникальный идентификатор
...
- Сущность "Целевое значение устройства"
  - id - уникальный идентификатор
...
- Сущность "Телеметрия текущего значения"
  - id - уникальный идентификатор
  - value - значение
...
- Блок управления — Устройство (один-ко-многим): один блок управления может быть подключен к нескольким устройствам, и каждое устройство принадлежит только одному блоку управления.
...
- Тип устройства - Протокол взаимодйествия с устройством (один-к-одному): для одного типа устройства есть один протокол взаимодействия и наоборот
