...
ER-диаграмму я не стал бить по различным БД, а представил общие связи между объектами - [er_diagram.puml](er_diagram.puml)

![er_diagram.png](er_diagram.png)

## 1.4 Создание и документирование API

В данном задании предлагается задокументировать API для взаимодействия м/у сервисами "Управление устройствами" и "Телеметрия". Но в моей схеме такого взаимодействия нет, т.к. оно не нужно. Да и в примере из задания API приведено для взаимодействия пользователя с данными сервисами.
Поэтому здесь приведено API для пользовательских запросов.

### 1.4.1 Выбор типа API

Для обработки пользовательских запросов будет использоваться REST API

### 1.4.2 Проектирование API для микросервиса «Управление устройствами»

Описание API можно посмотреть [тут](./device_management/swagger.yaml)
